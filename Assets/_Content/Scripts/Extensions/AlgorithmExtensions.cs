...
namespace Extensions
{
	public static class AlgorithmExtensions
	{
		...
		/// <returns>The mean of the sequence.</returns>
		public static double Mean<T>(this IEnumerable<T> sequence, Func<T, double> toDouble) =>
			sequence.ToList().Mean(toDouble);
		...
		/// <param name="toDouble">The function to convert each item to double.</param>
		/// <returns>The mean of the sequence.</returns>
		public static double Mean<T>(this IList<T> list, Func<T, double> toDouble) => list.Select(toDouble)
			.Aggregate(0d, (agg, item) => agg + item, total => total / list.Count());
		...
		/// <param name="toDouble">The function to convert each item to double.</param>
		/// <returns>The variance of the list.</returns>
		public static double Variance<T>(this IEnumerable<T> sequence, Func<T, double> toDouble) =>
			sequence.ToList().Variance(toDouble);
		...
		/// <param name="toDouble">The function to convert each item to double.</param>
		/// <returns>The variance of the list.</returns>
		public static double Variance<T>(this IEnumerable<T> sequence, double mean, Func<T, double> toDouble) =>
			sequence.ToList().Variance(mean, toDouble);
		...
		/// <param name="toDouble">The function to convert each item to double.</param>
		/// <returns>The variance of the list.</returns>
		public static double Variance<T>(this IList<T> list, Func<T, double> toDouble) =>
			list.Variance(list.Mean(toDouble), toDouble);
		...
		/// <param name="toDouble">The function to convert each item to double.</param>
		/// <returns>The variance of the list.</returns>
		public static double Variance<T>(this IList<T> list, double mean, Func<T, double> toDouble) => list.Count == 0
			? 0
			: list.Select(toDouble)
				.Aggregate(0d, (agg, item) => Math.Pow(item - mean, 2), total => total / (list.Count - 1));
		...
		public static double Median<T>(this IEnumerable<T> sequence, Func<T, double> getValue) =>
			Median(sequence.Select(getValue));
		...
		/// <param name="getValue">Logic to get a double from each element.</param>
		/// <returns>The standard deviation of the sequence.</returns>
		public static double StandardDeviation<T>(this IEnumerable<T> sequence, Func<T, double> getValue) =>
			sequence.Select(getValue).StandardDeviation();
